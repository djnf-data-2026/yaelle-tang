...
# Check for Personal Income data
...
**Possible story angle**
Personal income in Delaware County grew 10.98% between 2022 and 2024, yet GDP was the only one in the region to shrink. Residents may be earning more by working elsewhere while local industries are losing ground. This disconnect could be worth a closer look.

# GDP by industry (in thousands of current dollars)
```{r}
...
```
```{r}
change_most <- greater_philly_industry |>
